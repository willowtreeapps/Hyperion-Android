...
class MeasurementOverlayView extends FrameLayout {
    ...
    MeasurementOverlayView(Context context) {
        ...
        measurementTextOffset = getResources().getDimensionPixelSize(R.dimen.hgc_measurement_text_offset);
    ...
    private TextView makeMeasurementView(@Px int measurement) {
        ...
        tv.setBackgroundResource(R.drawable.hgc_rounded_measurement);
        layoutTextView(tv);
        return tv;
    }
