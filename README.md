...
or Gradle:
```groovy
compile 'com.willowtreeapps.hyperion:hyperion-core:0.9.8'
```
...
```groovy
debugCompile 'com.willowtreeapps.hyperion:hyperion-core:0.9.8'
debugCompile 'com.willowtreeapps.hyperion:hyperion-attr:0.9.8'
debugCompile 'com.willowtreeapps.hyperion:hyperion-measurement:0.9.8'
debugCompile 'com.willowtreeapps.hyperion:hyperion-disk:0.9.8'
debugCompile 'com.willowtreeapps.hyperion:hyperion-recorder:0.9.8'
```
