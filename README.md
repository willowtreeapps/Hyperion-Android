...
or Gradle:
```groovy
debugImplementation 'com.willowtreeapps.hyperion:hyperion-core:0.9.28'
```
...
```groovy
releaseImplementation 'com.willowtreeapps.hyperion:hyperion-core-no-op:0.9.28'
```
...
```groovy
debugImplementation 'com.willowtreeapps.hyperion:hyperion-core:0.9.28'
debugImplementation 'com.willowtreeapps.hyperion:hyperion-attr:0.9.28'
debugImplementation 'com.willowtreeapps.hyperion:hyperion-build-config:0.9.28'
debugImplementation 'com.willowtreeapps.hyperion:hyperion-crash:0.9.28'
debugImplementation 'com.willowtreeapps.hyperion:hyperion-disk:0.9.28'
debugImplementation 'com.willowtreeapps.hyperion:hyperion-geiger-counter:0.9.28'
debugImplementation 'com.willowtreeapps.hyperion:hyperion-measurement:0.9.28'
debugImplementation 'com.willowtreeapps.hyperion:hyperion-phoenix:0.9.28'
debugImplementation 'com.willowtreeapps.hyperion:hyperion-recorder:0.9.28'
debugImplementation 'com.willowtreeapps.hyperion:hyperion-shared-preferences:0.9.28'
debugImplementation 'com.willowtreeapps.hyperion:hyperion-timber:0.9.28'
```
