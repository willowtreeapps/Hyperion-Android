...
or Gradle:
```groovy
debugImplementation 'com.willowtreeapps.hyperion:hyperion-core:0.9.13'
```
...
```groovy
debugImplementation 'com.willowtreeapps.hyperion:hyperion-core:0.9.13'
debugImplementation 'com.willowtreeapps.hyperion:hyperion-attr:0.9.13'
debugImplementation 'com.willowtreeapps.hyperion:hyperion-measurement:0.9.13'
debugImplementation 'com.willowtreeapps.hyperion:hyperion-disk:0.9.13'
debugImplementation 'com.willowtreeapps.hyperion:hyperion-recorder:0.9.13'
debugImplementation 'com.willowtreeapps.hyperion:hyperion-phoenix:0.9.13'
```
